...
/datum/map_template/ruin/space/spacemall
	...
	name = "Space Mall"
	description = "An old shopping centre, owned by a former member of Nanotrasen's board of directors.." // [CELADON-EDIT]
...
/datum/map_template/ruin/space/onefull
	...
	name = "Nanotrasen Refueling Station" // [CELADON-EDIT]
	description = "An abandoned Nanotrasen refueling post evacuated after an attempted plasmaflood. Since then, hivebots and a small Ramzi Clique salvage team have attempted to claim the station." // [CELADON-EDIT]
